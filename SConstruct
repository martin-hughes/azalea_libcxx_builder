...
def main_build_script(cfg_env):
  ...
  env['CXXFLAGS'] = '-Wall -fno-pic -mno-red-zone -nostdinc++ -nostdinc -nostdlib -nodefaultlibs -mcmodel=large -ffreestanding -fno-exceptions -std=c++17 -U _LINUX -U __linux__ -D __AZALEA__ -D _LIBCPP_BUILDING_LIBRARY'
